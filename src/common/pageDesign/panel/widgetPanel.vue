<template>
  <div id="widget-panel">
    ...
    <div class="widget-wrap">
      <text-list-wrap
        v-if="widgetClassifyList[0].show"
        :style="getStyle(0)"
      />
      <shape-list-wrap
        v-if="widgetClassifyList[1].show"
        :style="getStyle(1)"
      />
      <img-list-wrap
        v-if="widgetClassifyList[2].show"
        :style="getStyle(2)"
      />
      <!-- 模板选择 -->
      <panel-templateSelect
        v-if="widgetClassifyList[4].show"
        :style="getStyle(4)"
      ></panel-templateSelect>
    </div>
  </div>
...
import panelTemplateSelect from './templateSelect.vue'
export default {
  name: NAME,
  components: {
    panelTemplateSelect, // 模板选择
  },
  data () {
    return {
      widgetClassifyList: [
