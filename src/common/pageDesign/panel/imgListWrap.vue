  ...
  data () {
    return {
      ...
      recommendImgList: [
        {
          id: 1,
          url: 'http://127.0.0.1:8080/static/template/1.png',
          ratio: 208 / 78
        },
        {
          id: 2,
          url: 'http://127.0.0.1:8080/static/template/bottom.png',
          ratio: 800 / 130
        },
        {
          id: 3,
          url: 'http://127.0.0.1:8080/static/template/bottomTop.png',
          ratio: 541 / 104
        },
        {
          id: 4,
          url: 'http://127.0.0.1:8080/static/template/rightbottom.png',
          ratio: 256 / 240
        },
        {
          id: 5,
          url: 'http://127.0.0.1:8080/static/template/618.png',
          ratio: 110 / 54
        },
        {
          id: 6,
